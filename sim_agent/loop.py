...
class Loop:
    ...
    def step(self, command: Optional[str] = None,
             base_constraints: Optional[C.Constraints] = None) -> TickResult:
        ...
        # as defaults; a typed English command is parsed and overrides them.
        parsed = agent.parse_command(command, self.world) if command else {}
        ...
        if not self.optimize:
            ...
            if result is None:
                ...
                explanation = agent.explain_result(result, self.world)
